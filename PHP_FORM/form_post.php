...
<html lang="en">
  ...
  <body>
      <form name = "" action="hasil_post.php" method="post" >
      ...
      <div class="main">
        <div id="name">
            ...
            <h2 class="name">Pelabuhan Asal </h2>
              <input class="pelabuhan" type="text" name="pelabuhan">

            <h2 class="name">Tanggal Berangkat </h2>
            <input class="date-time" type="datetime-local"  name="date-time" >

            <h2 class="name">Tanggal Kembali </h2>
            <input class="date-time" type="datetime-local"  name="date-time" >

            <h2 class="name">Nama Kapal </h2>
              <input class="namakapal" type="text" name="namakapal">

            <h2 class="name">Ukuran Kapal</h2>
              <select class="option" name="kapal">
            ...
            <div class="option2" name="hasil[]"> 
                  <input type="checkbox"  name="hasil[]" value="IkanTongkol"> Ikan Tongkol  
                  <input type="checkbox"  name="hasil[]"  value="IkanTuna"> Ikan Tuna  
                  <input type="checkbox"  name="hasil[]"  value="IkanBandeng"> Ikan Bandeng 
                  <input type="checkbox"   name="hasil[]" value="IkanCakalang"> Ikan Cakalang <br>
                  <input type="checkbox"   name="hasil[]" value="IkanTeri"> Ikan Teri  
                  <input type="checkbox"   name="hasil[]" value="IkanKakap"> Ikan Kakap  
                  <input type="checkbox"   name="hasil[]" value="IkanSarden"> Ikan Sarden  
                  <input type="checkbox"   name="hasil[]" value="IkanTenggiri"> Ikan Tenggiri
                  <input type="checkbox"   name="hasil[]" value="IkanPeperek"> Ikan Peperek
                  <input type="checkbox"   name="hasil[]" value="IkanSelar"> Ikan Selar
                  <input type="checkbox"   name="hasil[]" value="Cumi-Cumi"> Cumi - Cumi
                  <input type="checkbox"   name="hasil[]" value="Udang"> Udang
                  <input type="checkbox"   name="hasil[]" value="Kepiting"> Kepiting
            </div>

            <h2 class="name">Volume Tangkapan Ikan</h2>
              <select class="option1" name="volume">
            ...
            <h2 class="name">Total Tangkapan Ikan</h2>
              <select class="option1" name="total">
            ...
            <h2 class="name">Alat Tangkap </h2>
              <select class="option3" name="alat">
