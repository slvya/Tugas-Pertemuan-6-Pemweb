 ...
 <body>
    ...
    <table   border="0" cellspacing="0" align="center"  >
        ...
        <tr> 
             ...
             <td class="titik"> :  </td>
             <td  > <?php echo $_POST['pelabuhan'] ?> </td>
        </tr>
        
        <tr> 
             <td  > Tanggal Berangkat  </td>
             <td class="titik"> :  </td>
             <td  > <?php echo $_POST['date-time'] ?> </td>
        </tr>
        ...
        <tr> 
             <td  > Nama Kapal </td>
             <td class="titik"> :  </td>
             <td  > <?php echo $_POST['namakapal'] ?> </td>
        </tr>
        
        <tr> 
             <td  >  Ukuran Kapal  </td>
             <td class="titik"> :  </td>
             <td  > <?php echo $_POST['kapal'] ?> </td>
        </tr>

        <tr> 
             <td  >Hasil Tangkapan Ikan </td>
             <td class="titik"> :  </td>
             <td  > <?php $hasil = $_POST['hasil' ] ; foreach ( $hasil as $value ) 
             {    echo $value ."<br>";
